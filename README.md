...
The context API solves the issue of needing to prop-drill from all levels of your application

2. In your own words, describe `actions`, `reducers` and the `store` and their role in Redux. What does each piece do? Why is the store known as a 'single source of truth' in a redux application?

In Redux, store is what holds all your data the application uses, reducers manipulates the data when it receives an action, and actions tell the reducer to manipulate the already stored data.

3. What does `redux-thunk` allow us to do? How does it change our `action-creators`?

Redux-thunk allows us to call the action creators and return a function. It can be used to delay the dispatch of an action until a certain condition is met.

4. What is your favorite state management system you've learned and this sprint? Please explain why!

I've enjoyed learning about Context API. I like the idea of being able to create highly reusable state management and avoiding prop-drilling.
